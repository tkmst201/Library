...
data:
  ...
  bundledCode: "#line 1 \"Test/SuffixArray.sa_is.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/suffixarray\"\
    \r\n\r\n#line 1 \"String/SuffixArray.hpp\"\n\n\n\r\n#include <string>\r\n#include\
    \ <vector>\r\n#include <algorithm>\r\n#include <cassert>\r\n\r\n/*\r\nlast-updated:\
    \ 2020/08/25\r\n\r\n# \u6982\u8981\r\nSuffixArray \u306E\u8A08\u7B97\u306F SA-IS:\
    \ \u0398(|s|)\r\nLCP \u914D\u5217\u306E\u8A08\u7B97\u306F Kasai&s's algorighm:\
    \ \u0398(|s|)\r\n\u6587\u5B57\u5217 p \u306E\u691C\u7D22\u306F LCP \u914D\u5217\
    \u3092\u7528\u3044\u305F\u4E8C\u5206\u63A2\u7D22: \u0398(|p| + log|s|)\r\n\r\n\
    # \u4ED5\u69D8\r\nSuffixArray(string_type s) :\r\n\tbuild(s)\r\n\r\nsize_type\
    \ size() const noexcept :\r\n\t\u6642\u9593\u8A08\u7B97\u91CF: \u0398(1)\r\n\t\
    \u6587\u5B57\u5217 s \u306E\u5927\u304D\u3055 |s| \u3092\u8FD4\u3059\r\n\r\nconst\
    \ std::vector<size_type> & get_sa() const noexcept :\r\nconst std::vector<size_type>\
  ...
  requiredBy: []
  timestamp: '2020-09-08 10:02:39+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: Test/SuffixArray.sa_is.test.cpp
layout: document
redirect_from:
- /verify/Test/SuffixArray.sa_is.test.cpp
- /verify/Test/SuffixArray.sa_is.test.cpp.html
