...
# :warning: Mathematics/Matrix(double).hpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#540b21ecdb276f5087ee585cedd6d5d0">Mathematics</a>
* <a href="{{ site.github.repository_url }}/blob/master/Mathematics/Matrix(double).hpp">View this file on GitHub</a>
...
Matrix inverse() const : 逆行列を返す(存在しない場合は空行列)
...
#endif // INCLUDE_GUARD_MATRIX_DOUBLE_HPP
```
{% endraw %}
...
{% raw %}
```cpp
#line 1 "Mathematics/Matrix(double).hpp"
