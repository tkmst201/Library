...
# :warning: Mathematics/Matrix(double).cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#540b21ecdb276f5087ee585cedd6d5d0">Mathematics</a>
* <a href="{{ site.github.repository_url }}/blob/master/Mathematics/Matrix(double).cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "Mathematics/Matrix(double).cpp"
#include <iostream>
#include <cassert>
#include <vector>
#include <utility>
